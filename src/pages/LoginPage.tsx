    ...
    >
      <div className="w-full">
        ...
        <form className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-[#1E1E2C] border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all placeholder-gray-600"
              />
              <button type="button" className="absolute right-4 top-1/2 transform -translate-y-1/2 text-xs font-bold text-gray-400 hover:text-white">
                SHOW
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-gray-700 bg-[#1E1E2C] text-purple-600 focus:ring-purple-500" />
        ...
        <div className="flex justify-center gap-4 mb-8">
          {['G', 'f', '⊞', ''].map((provider, i) => (
            <button key={i} className="w-10 h-10 rounded-full bg-[#1E1E2C] border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-gray-500 transition-all">
              {provider}
            </button>
          ))}
        </div>
