      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-y-auto no-scrollbar flex flex-col">
          ...
          <div className="p-4 sm:p-6 lg:p-8 max-w-[1400px] w-full mx-auto flex-1">
            ...
            {/* Notification List */}
            <div className="bg-white dark:bg-[#12121D] border border-gray-200 dark:border-[#2A2A38] rounded-xl sm:rounded-2xl shadow-sm sm:shadow-xl flex flex-col mb-10 transition-colors">
                ...
                <div key={notif.id} className={`p-3 sm:p-4 lg:p-6 flex gap-3 sm:gap-4 lg:gap-6 hover:bg-gray-50 dark:hover:bg-[#1E1E2C] transition-colors cursor-pointer ${index !== notifications.length - 1 ? 'border-b border-gray-100 dark:border-[#2A2A38]' : ''} ${notif.unread ? 'bg-gray-50/50 dark:bg-[#1E1E2C]/50' : ''}`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-0.5 sm:gap-1 mb-1 sm:mb-1.5">
                      <h3 className={`text-xs sm:text-sm lg:text-base font-bold truncate pr-2 ${notif.unread ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400'}`}>{notif.title}</h3>
